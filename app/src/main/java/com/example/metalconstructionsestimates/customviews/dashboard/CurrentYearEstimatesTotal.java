...
public class CurrentYearEstimatesTotal extends LinearLayout {
    private TextView textViewCurrentYearEstimatesTotalLabel;
    ...
    private void init() {
        ...
        textViewCurrentYearEstimatesTotalLabel = findViewById(R.id.textView_current_year_estimates_total_label);
