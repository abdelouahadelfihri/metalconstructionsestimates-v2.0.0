    ...
    public void onCreate(SQLiteDatabase db){
        try{
            ...
            db.execSQL("CREATE TABLE estimate(id INTEGER PRIMARY KEY AUTOINCREMENT,"
                    + "doneIn INTEGER,issueDate INTEGER,expirationDate INTEGER,dueDate INTEGER,dueTerms TEXT,status TEXT,customer INTEGER,excludingTaxTotal Float,discount float,excludingTaxTotalAfterDiscount float," +
