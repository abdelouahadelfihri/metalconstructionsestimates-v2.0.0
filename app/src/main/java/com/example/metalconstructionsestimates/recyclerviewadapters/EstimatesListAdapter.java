...
public class EstimatesListAdapter extends RecyclerView.Adapter<EstimatesListAdapter.EstimateViewHolder>{
    ...
    public void onBindViewHolder(EstimateViewHolder holder, int position){
        ...
        String formattedIssueDate = issueDateMillis != null
                ? new SimpleDateFormat("dd/MM/yyyy", Locale.getDefault()).format(new Date(issueDateMillis))
                : "";
        String estimateCreationDate = "Issue Date : " + formattedIssueDate;
